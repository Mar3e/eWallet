...
return currentUser;
  ...
  @override
  Future<User?> addUser(String userName, String userEmail, int userPhone, String userPassword) async{
try {
    await Future.delayed(const Duration(seconds: 3));
  users.add(User(userId: users.length, userName: userName, userPassword: userPassword, userEmail: userEmail, userPhone: userPhone));
  return users.last;
} catch (e) {
  return null;
}
...
var users = <User>[
  ...
  User(
    ...
    userPhone: 321654987,
    userBalance:100.0,profilePic: "assets/images/avatar.png"),
